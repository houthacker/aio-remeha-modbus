...
SENSOR_REGISTERS: Final[list[ModbusVariableDescription]] = [
    ...
    MetaRegisters.GENERATOR_STARTS_TOTAL,
    MetaRegisters.GENERATOR_HOURS_TOTAL,
    MetaRegisters.BACKUP1_STARTS,
    MetaRegisters.BACKUP1_HOURS,
    MetaRegisters.BACKUP2_STARTS,
    MetaRegisters.BACKUP2_HOURS,
    MetaRegisters.POWER_ON_HOURS,
    MetaRegisters.CH_ENERGY_CONSUMPTION,
    MetaRegisters.DHW_ENERGY_CONSUMPTION,
    MetaRegisters.COOLING_ENERGY_CONSUMPTION,
    MetaRegisters.BACKUP_ENERGY_CONSUMPTION,
